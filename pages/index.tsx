  ...
  const PageContent = () => {
    return (
      <>
        <style jsx global>
          {`
        @media screen and (min-width: 840px) and (max-width: 2560px) { 
          body {
        ...
        <Card backgroundColor="#" className={styles.bigcontainer}  >
          ...
          <CardBody >
            <div className={styles.container} color={"white"} >
              ...
              <div style={{ marginLeft: '25px', color: 'white', marginTop: "20px" }}  className="alldiv">
              ...
              <div className="tdiv">
              <h3 className={styles.progress} style={{ fontWeight: '600', fontSize: '20px' }} >Mint Process</h3>
              <ul className={styles.lists} >
                <li className={styles.txt}>Free Mint</li>
                <li className={styles.txt}>GTD Mint</li>
                <li className={styles.txt}>FCFS Mint</li>
                <li className={styles.txt}>Public Mint</li>
              </ul>
              <Image src = "/mints.png"  className={styles.gradient}/>
              <ul style={{display: 'flex', listStyleType: 'none', justifyContent: 'space-around', width: '76%', padding: '2px', top: '5px', position: 'relative'}}
                                

              >
                <li className={styles.lists12}>2h
              <Image className={styles.listsimg} src = "/check.png"  /></li>
                <li className={styles.lists12}>2h<Image className={styles.listsimg1} src = "/upnext.png" /></li>
                <li className={styles.lists13} >4h</li>
                <li className={styles.lists1}>8h</li>
              </ul>
              </div>
